...
- **Projectile Speed**: 5 tiles/second - moderate speed with tracking capability
...
- **Projectile Speed**: 3 tiles/second - slower arcing grenades with gravity effect
...
- **Projectile Speed**: 9 tiles/second - fast but visible projectiles with high precision
