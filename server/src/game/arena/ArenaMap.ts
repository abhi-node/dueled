...
export interface ArenaConfig {
  ...
  obstacles: Obstacle[];
  walls: Array<{ x1: number; y1: number; x2: number; y2: number }>; // For client rendering
...
export class ArenaMap {
  ...
  private static initializeArenas(): void {
    ...
    this.ARENA_CONFIGS.set('classic', {
      ...
      walls: [
        // Convert obstacles to walls for client rendering
        { x1: 14, y1: 14, x2: 16, y2: 14 }, // center_pillar top
        { x1: 16, y1: 14, x2: 16, y2: 16 }, // center_pillar right
        { x1: 16, y1: 16, x2: 14, y2: 16 }, // center_pillar bottom
        { x1: 14, y1: 16, x2: 14, y2: 14 }, // center_pillar left
        { x1: 12, y1: 8, x2: 18, y2: 8 },   // top_cover
        { x1: 12, y1: 21, x2: 18, y2: 21 }  // bottom_cover
      ],
      backgroundType: 'sand',
    ...
    this.ARENA_CONFIGS.set('pillars', {
      ...
      walls: [
        // Corner pillars as wall rectangles
        { x1: 8, y1: 8, x2: 10, y2: 8 }, { x1: 10, y1: 8, x2: 10, y2: 10 }, { x1: 10, y1: 10, x2: 8, y2: 10 }, { x1: 8, y1: 10, x2: 8, y2: 8 },
        { x1: 18, y1: 8, x2: 20, y2: 8 }, { x1: 20, y1: 8, x2: 20, y2: 10 }, { x1: 20, y1: 10, x2: 18, y2: 10 }, { x1: 18, y1: 10, x2: 18, y2: 8 },
        { x1: 8, y1: 18, x2: 10, y2: 18 }, { x1: 10, y1: 18, x2: 10, y2: 20 }, { x1: 10, y1: 20, x2: 8, y2: 20 }, { x1: 8, y1: 20, x2: 8, y2: 18 },
        { x1: 18, y1: 18, x2: 20, y2: 18 }, { x1: 20, y1: 18, x2: 20, y2: 20 }, { x1: 20, y1: 20, x2: 18, y2: 20 }, { x1: 18, y1: 20, x2: 18, y2: 18 },
        // Center cross
        { x1: 13, y1: 12, x2: 15, y2: 12 }, { x1: 15, y1: 12, x2: 15, y2: 16 }, { x1: 15, y1: 16, x2: 13, y2: 16 }, { x1: 13, y1: 16, x2: 13, y2: 12 }
      ],
    ...
    this.ARENA_CONFIGS.set('field', {
      ...
      walls: [
        // Single cover as rectangle
        { x1: 16, y1: 11, x2: 19, y2: 11 }, { x1: 19, y1: 11, x2: 19, y2: 14 }, { x1: 19, y1: 14, x2: 16, y2: 14 }, { x1: 16, y1: 14, x2: 16, y2: 11 }
      ],
    ...
    this.ARENA_CONFIGS.set('quarters', {
      ...
      walls: [
        // Top wall
        { x1: 7, y1: 5, x2: 13, y2: 5 },
        // Bottom wall
        { x1: 7, y1: 14, x2: 13, y2: 14 },
        // Center block
        { x1: 9, y1: 9, x2: 11, y2: 9 }, { x1: 11, y1: 9, x2: 11, y2: 11 }, { x1: 11, y1: 11, x2: 9, y2: 11 }, { x1: 9, y1: 11, x2: 9, y2: 9 }
      ],
