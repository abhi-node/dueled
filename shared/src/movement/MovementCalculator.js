...
export class MovementCalculator {
     ...
     */
    calculateMovement(currentPosition, input, deltaTime) {
     ...
     */
    validateMovement(oldPosition, newPosition, bounds) {
        if (!bounds) {
            return newPosition;
        }
        // Clamp to bounds
...
//# sourceMappingURL=MovementCalculator.js.map